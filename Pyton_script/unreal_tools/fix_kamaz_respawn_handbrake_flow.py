...
OUT_PATH = os.path.join(
    ...
    "BlueprintAutomation",
    "fix_kamaz_respawn_handbrake_flow.json",
)

NODE_IA_HANDBRAKE = (
    "/Game/CityPark/Kamaz/model/KamazBP_HandlingAudit."
    "KamazBP_HandlingAudit:EventGraph.K2Node_EnhancedInputAction_13"
)
NODE_SET_BRAKEVALUE = (
    "/Game/CityPark/Kamaz/model/KamazBP_HandlingAudit."
    "KamazBP_HandlingAudit:EventGraph.K2Node_VariableSet_21"
)
NODE_SET_START_BRAKE_FALSE_SPACE = (
    "/Game/CityPark/Kamaz/model/KamazBP_HandlingAudit."
...
NODE_SET_BRAKE_INPUT_MAIN = (
    "/Game/CityPark/Kamaz/model/KamazBP_HandlingAudit."
    "KamazBP_HandlingAudit:EventGraph.K2Node_CallFunction_1"
)
...
try:
    batch = {
        "nodes": [
            {
                "id": "completed_sink_start_brake_false",
                "type": "variable_set",
            ...
            {
                "id": "brake_trigger_release_start_brake",
                "type": "variable_set",
                "variable": "bStartBrakeApplied",
                "x": -8208,
                "y": -12112,
        ...
        "links": [
            {
                ...
                "from_pin": "Completed",
                "to_node": "completed_sink_start_brake_false",
                "to_pin": "execute",
            },
            {
                "from_node_path": NODE_SET_START_BRAKE_FALSE_SPACE,
                "from_pin": "then",
            ...
            },
            {
                ...
                "from_pin": "then",
                "to_node": "brake_trigger_release_start_brake",
                "to_pin": "execute",
            },
            {
                "from_node": "brake_trigger_release_start_brake",
                "from_pin": "then",
                "to_node_path": NODE_SET_HANDBRAKE_FALSE,
                "to_pin": "execute",
            },
            {
                "from_node_path": NODE_SET_HANDBRAKE_FALSE,
                "from_pin": "then",
