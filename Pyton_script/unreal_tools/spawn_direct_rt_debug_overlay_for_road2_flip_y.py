...
OUTPUT_BASENAME = "spawn_direct_rt_debug_overlay_for_road2_flip_y"
...
def _log(message: str) -> None:
    unreal.log(f"[spawn_direct_rt_debug_overlay_for_road2_flip_y] {message}")
...
def run(output_dir: str | None = None) -> dict:
    ...
    module.DEBUG_WORLD_UV_FLIP_Y = True
    ...
    payload = {
        ...
        "notes": [
            ...
            "This variant flips Y in world-to-UV mapping to validate axis orientation.",
        ],
    }
