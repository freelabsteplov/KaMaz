...
OUTPUT_BASENAME = "fix_tverskaya_doubleside_nanite"
TARGET_MESHES = [
    "/Game/Datasmith/DS_Tverskaya_6_5/Geometries/doubleside.doubleside",
    "/Game/Datasmith/DS_Tverskaya_6_5/Geometries/doubleside_blend.doubleside_blend",
]


def _log(message: str) -> None:
    unreal.log(f"[fix_tverskaya_doubleside_nanite] {message}")
...
def run(output_dir: str | None = None) -> dict:
    ...
    result = {
        ...
        "entries": entries,
        "summary": f"tverskaya_doubleside updated={updated_count}/{len(TARGET_MESHES)}",
        "notes": [
            "This changes only the two DS_Tverskaya_6_5 doubleside geometry meshes that produce the remaining Nanite/translucent warnings.",
